...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Barlow:300,600,700,900|Roboto:100,300,500,700&display=swap" rel="stylesheet">
                            ...
                            <div class="col-xl-12 ">
                                <div class="footer-copy-right text-center">
                                    <p>
                                        ...
                                        </script> All rights reserved | This template is customized by {{$system['app_name']}}
                                    </p>
                                </div>
                            </div>
                        </div>
