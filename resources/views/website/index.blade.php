...
<head>
    ...
    <link rel="stylesheet" href="a{{ url('/') }}/css/website/owl.carousel.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/ticker-style.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/flaticon.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/slicknav.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/animate.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/magnific-popup.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/fontawesome-all.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/themify-icons.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/slick.css">
    <link rel="stylesheet" href="{{ url('/') }}/css/website/nice-select.css">
...
<body>
                            ...
                            <div class="col-xl-12">
                                <div class="row d-flex justify-content-between align-items-center">
                                    <div class="header-info-left">
                                        <ul>
                                            <li class="title"><i class="fa fa-home text-danger"></i> Dashboard
                                            </li>
                                    ...
                                    <div class="header-info-right">
                                        <ul class="header-date">
                                            <li><i class="fa fa-user text-danger"></i> {{ Auth::user()->name }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 d-none d-md-block">
                                <div class="logo">
                                    <a href="{{ route('home') }}"><img src="{{ url('/') }}/img/logo/TF.png"
                                            alt=""></a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-12 header-flex">
                                ...
                                <div class="sticky-logo">
                                    <a href="{{ route('home') }}"><img style="width: 20%;"
                                            src="{{ url('/') }}/img/logo/TF.png" alt=""></a>
                                </div>
                                <!-- Main-menu -->
                                <?php echo $menu; ?>
                            </div>
                                        ...
                                        <div class="trend-top-img">
                                            ...
                                            <div class="trend-top-cap">
                                                ...
                                                <h2><a href="latest_news.html" data-animation="fadeInUp"
                                                        data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In White
                                ...
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-tittle">
                                        <div class="footer-pera">
                                            ...
                                            <p class="info2">198 West 21th Street, Suite 721 New York,NY 10010
                                            </p>
                                            <p class="info2">Phone: +95 (0) 123 456 789 Cell: +95 (0) 123 456
                                                789</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="{{ url('/') }}/js/website/vendor/modernizr-3.5.0.min.js"></script>
    <!-- Jquery, Popper, Bootstrap -->
    <script src="{{ url('/') }}/js/website/vendor/jquery-1.12.4.min.js"></script>
    <script src="{{ url('/') }}/js/website/popper.min.js"></script>
    <script src="{{ url('/') }}/js/website/bootstrap.min.js"></script>
    <!-- Jquery Mobile Menu -->
    <script src="{{ url('/') }}/js/website/jquery.slicknav.min.js"></script>

    <!-- Jquery Slick , Owl-Carousel Plugins -->
    <script src="{{ url('/') }}/js/website/owl.carousel.min.js"></script>
    <script src="{{ url('/') }}/js/website/slick.min.js"></script>
    <!-- Date Picker -->
    <script src="{{ url('/') }}/js/website/gijgo.min.js"></script>
    <!-- One Page, Animated-HeadLin -->
    <script src="{{ url('/') }}/js/website/wow.min.js"></script>
    <script src="{{ url('/') }}/js/website/animated.headline.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.magnific-popup.js"></script>

    <!-- Scrollup, nice-select, sticky -->
    <script src="{{ url('/') }}/js/website/jquery.scrollUp.min.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.nice-select.min.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.sticky.js"></script>

    <!-- contact js -->
    <script src="{{ url('/') }}/js/website/contact.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.form.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.validate.min.js"></script>
    <script src="{{ url('/') }}/js/website/mail-script.js"></script>
    <script src="{{ url('/') }}/js/website/jquery.ajaxchimp.min.js"></script>

    <!-- Jquery Plugins, main Jquery -->
    <script src="{{ url('/') }}/js/website/plugins.js"></script>
